...
- [Advanced googletest Topics](#advanced-googletest-topics)
  ...
  * [Sharing Resources Between Tests in the Same Test Case](#sharing-resources-between-tests-in-the-same-test-case)
  ...
  * [Getting the Current Test's Name](#getting-the-current-tests-name)
  ...
  * [Running Test Programs: Advanced Options](#running-test-programs-advanced-options)
    ...
    + [Controlling Test Output](#controlling-test-output)
      ...
      - [Generating an JSON Report](#generating-an-json-report)
